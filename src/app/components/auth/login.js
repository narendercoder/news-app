  ...
  return (
    <div className="sm:max-w-sm py-40 flex-1 text-xs sm:text-sm flex flex-col items-center gap-5 sm:gap-6 h-screen">
      ...
      <button
        ...
        className="w-full max-w-[20ch] border border-white border-solid uppercase py-2 duration-300 relative after:absolute after:top-0 after:right-full after:bg-red-500 after:z-10 after:w-full after:h-full overflow-hidden hover:after:translate-x-full after:duration-300 "
      >
